...
enum SpellAttr0
{
    ...
    SPELL_ATTR0_UNK3                             = 0x00000008, //  3 not set in 2.4.3
...
enum SpellAttr2
{
    ...
    SPELL_ATTR2_UNK8                             = 0x00000100, //  8 not set in 2.4.3
    ...
    SPELL_ATTR2_UNK15                            = 0x00008000, // 15 not set in 2.4.3
...
enum SpellAttr3
{
    ...
    SPELL_ATTR3_BLOCKABLE_SPELL0                 = 0x40000000, // 30 Shaman's Fire Nova 3.3.0, Sweeping Strikes 3.3.0
    SPELL_ATTR3_BLOCKABLE_SPELL1                 = 0x80000000  // 31
};
...
enum SpellAttr6
{
    ...
    SPELL_ATTR6_UNK15                            = 0x00008000, // 15 not set in 2.4.3
    ...
    SPELL_ATTR6_UNK23                            = 0x00800000, // 23 not set in 2.4.3
    SPELL_ATTR6_UNK24                            = 0x01000000, // 24 not set in 2.4.3
    SPELL_ATTR6_UNK25                            = 0x02000000, // 25 not set in 2.4.3
    SPELL_ATTR6_UNK26                            = 0x04000000, // 26 not set in 2.4.3
    SPELL_ATTR6_UNK27                            = 0x08000000, // 27 not set in 2.4.3
    SPELL_ATTR6_UNK28                            = 0x10000000, // 28 not set in 2.4.3
    SPELL_ATTR6_UNK29                            = 0x20000000, // 29 not set in 2.4.3
    SPELL_ATTR6_UNK30                            = 0x40000000, // 30 not set in 2.4.3
    SPELL_ATTR6_UNK31                            = 0x80000000  // 31 not set in 2.4.3
};
